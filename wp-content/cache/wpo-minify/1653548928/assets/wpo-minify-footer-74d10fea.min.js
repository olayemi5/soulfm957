...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://radiustheme.com/demo/wordpress/themes/fmwave/wp-includes/js/mediaelement/mediaelement-and-player.min.js - BEFORE\n- Error message: "+ e.message);}
try{
/*!
 * MediaElement.js
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://radiustheme.com/demo/wordpress/themes/fmwave/wp-includes/js/mediaelement/mediaelement-and-player.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://radiustheme.com/demo/wordpress/themes/fmwave/wp-includes/js/mediaelement/mediaelement-migrate.min.js\n- Error message: "+ e.message);}
